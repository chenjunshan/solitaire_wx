...
var Solitaire = (function () {
    ...
    Solitaire.prototype.shuffle = function () {
        this.deck.shuffle(); //洗牌
    };
    Solitaire.prototype.deleteData = function () {
        this.columns = [[], [], [], [], [], [], []];
        this.wastes = [];
        this.hands = [];
        this.suits = [[], [], [], []];
    ...
    Solitaire.prototype.isOver = function (suits) {
    ...
    Solitaire.prototype.isDfsOver = function () {
    ...
    Solitaire.prototype.dfs = function (step) {
        console.log("123");
    ...
    Solitaire.prototype.isInFree = function (card_id) {
    ...
    Solitaire.prototype.isSuitable = function (card_id) {
        if (this.isInFree(card_id)) {
            return true;
        }
        for (var i = 0; i < 7; i++) {
            if (this.columns[i].length > 0) {
    ...
    Solitaire.prototype.isInSuit = function (card_id) {
        for (var i = 0; i < 4; i++) {
    ...
    Solitaire.prototype.isDraggable = function (card_id) {
        var i, j, card;
        if (this.isInSuit(card_id)) {
            return true;
        }
        if (this.isSuitable(card_id)) {
            return true;
        }
        for (i = 0; i < 7; i++) {
    ...
    Solitaire.prototype.isAddable = function (i, nextCard) {
    ...
    Solitaire.prototype.isSuitAddable = function (i, nextCard) {
    ...
    Solitaire.prototype.isWon = function () {
        for (var i = 0; i < 4; i++) {
            var len = this.suits[i].length;
            if (len != 13 || this.suits[i][len - 1].value != 13)
                return false;
...
__reflect(Solitaire.prototype, "Solitaire");
